...
class UserStatisticsPanelTest {
    ...
    void testConstructorFullFlow() {
        ...
        view.UserStatisticsPanel p = new view.UserStatisticsPanel(u);
        assertNotNull(p);
    }

    @Test
    void testTotalPlaytimeAllTiers() {
        view.UserStatisticsPanel p = new view.UserStatisticsPanel(makeUser(new java.util.ArrayList<>()));
    ...
    void testRecentlyPlayedAllTiers() {
        ...
        view.UserStatisticsPanel p = new view.UserStatisticsPanel(makeUser(games));
    ...
    void testMostPlayedNullBranch() {
        view.UserStatisticsPanel p = new view.UserStatisticsPanel(makeUser(List.of()));
    ...
    void testRecentlyPlayedBranchCoverage() {
        view.UserStatisticsPanel p = new view.UserStatisticsPanel(makeUser(new ArrayList<>()));
